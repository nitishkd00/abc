...
import { Fish, Shield, Zap, Users, Clock, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sign up with your email to participate in real-time auctions.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              ...
              <>
                ...
                <Link to="/auctions" className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-medium py-3 px-8 rounded-lg transition-colors duration-200">
                  Browse Auctions
                </Link>
              </>
            )}
